...
diff_df_max_sort_df.insert(2, "Event transition", [str(m)+'-'+str(n) for m,n in zip(row_max, col_max)]) 
...
diff_df_min_sort_df.insert(2, "Event transition", [str(m)+'-'+str(n) for m,n in zip(row_min, col_min)]) 
